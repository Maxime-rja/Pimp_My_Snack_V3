CREATE USER 'gpi2'@'%' IDENTIFIED BY 'network';
...
GRANT ALL PRIVILEGES ON exercices.* TO gpi2@%;

GRANT ALL PRIVILEGES ON tp_videos.* TO gpi2@%;
GRANT ALL PRIVILEGES ON tp_films.* TO gpi2@%;
GRANT ALL PRIVILEGES ON tp_etudiants.* TO gpi2@%;
GRANT ALL PRIVILEGES ON tp_livres.* TO gpi2@%;

GRANT ALL PRIVILEGES ON exm_juin2019_1.* TO gpi2@%;
GRANT ALL PRIVILEGES ON exm_juin2019_2.* TO gpi2@%;
GRANT ALL PRIVILEGES ON exm_juin2020_1.* TO gpi2@%;
GRANT ALL PRIVILEGES ON exm_juin2020_2.* TO gpi2@%;
