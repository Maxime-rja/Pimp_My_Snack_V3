...
<body>
    ...
    <div class="jumbotron jumbotron-fluid page-header" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-3 mt-lg-5">Sandwich</h1>
            <div class="d-inline-flex align-items-center text-white">
                <p class="m-0"><a class="text-white" href="">Home</a></p>
                <i class="fa fa-circle px-3"></i>
                <p class="m-0">Sandwich</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
        ...
        <div class="container py-5">
            ...
            <div class="product-item d-flex align-items-center text-center bg-light rounded px-3">                              
             ...
             <div class="product-item d-flex align-items-center text-center bg-light rounded px-3">                              
                ...
                <h4 class="font-weight-bold bg-primary text-white mb-0">1€</h4> <!-- afficher le prix de l'ingredient boisson selectionné -->
            </div>  
            <div class="product-item d-flex align-items-center text-center bg-light rounded px-3">                              
                <h5 class="font-weight-bold pl-3 pr-3"> Accompagnement : </h5>                        
                <h4 class="font-weight-bold bg-primary text-white mb-0">1€</h4> <!-- afficher le prix de l'ingredient accompagnement selectionné -->
            </div>
